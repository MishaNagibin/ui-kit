...
<!-- | defaultActiveItems | number[] | задать вкладки, которые по умолчанию активны, передавать нужно индекс вкладки (начинается с 0) | [] | -->
...
| isRelative | boolean | Делает позицию календаря относительной (по умолчанию она абсолютная) | false |
